...
def afk(update: Update, context: CallbackContext):
    ...
    if user.id in [777000, 1694909518]:
        return
    ...
    try:
        update.effective_message.reply_text("{} Anak Haram Telah Afk!{}".format(fname, notice))
    except BadRequest:
        pass
    ...
    if res:
        ...
        try:
            options = [
                "{} Dia Ada Di Sini!",
                "{} Dia Kembali!",
                "{} Dia Telah Berada Di Chat Haram!",
                "{} Dia Telah Hidup!",
                "{} Dia Telah Kembali Online!",
                "{} Dia Anak Anj!",
                "Selamat Datang Kembali Anak Haram! {}",
                "Where is {}?\nIn the chat!",
            ]
