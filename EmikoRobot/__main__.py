...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an anime-theme management bot [✨](https://telegra.ph/file/3f4c55755b365077bfc05.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Karman Robot", callback_data="karman_"),
    ],
    [
    ...
    [
        InlineKeyboardButton(
            text="➗ Add Kar Robot To Your Group ➗", url=f"t.me/{bu}?startgroup=new"
        ),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("KarmanRobot.modules." + module_name)
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            text="๏ I'm *Karman*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n Click on button bellow to get basic help for KarRobot.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton(
                            text="Source Code",
                            url="https://github.com/ArmanGG01/karRobot",
                        ),
                    ],
                    [
                        InlineKeyboardButton(
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, KarRobot now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            text="*๏ Karman support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on Karman.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                    [
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Arman", url="https://github.com/ArmanGG01"
                        ),
                        InlineKeyboardButton(
